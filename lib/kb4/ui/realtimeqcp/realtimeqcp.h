...
//FIXME если добавлять 2 курсор при видимосте графика false - пишется значение, а надо писать ---
//FIXME если поменять видимость линии 2 раза - то отобразится дельта
//FIXME при нажатии на колесико мышине рисуется линия курсора
